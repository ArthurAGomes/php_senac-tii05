...
$Itens = DatabaseRepository::getAllItems();
?>
...
<body class="bg-gradient-to-r from-blue-50 to-gray-100 p-6">
    <div class="max-w-4xl mx-auto bg-white p-8 shadow-lg rounded-lg">
        ...
        <a href="add_Itens$Itens.php" class="bg-green-500 text-white py-2 px-4 rounded-full shadow hover:bg-blue-600 transition duration-300 mb-6 inline-block">Adicionar Item</a>
                    ...
                    <?php foreach($Itens as $Itens): ?>
                        <tr class="border-b border-gray-200 hover:bg-green-100 transition duration-200">
                            ...
                            <td class="py-3 px-6 text-left">
                                ...
                                <a href="delete_Itens$Itens.php?id=<?= $Itens['id']; ?>" 
